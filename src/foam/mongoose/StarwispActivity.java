...
public class StarwispActivity extends FragmentActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        //m_Typeface = Typeface.createFromAsset(getAssets(), "fonts/DejaVuSerif.ttf");
        m_Typeface = Typeface.createFromAsset(getAssets(), "fonts/Ginger-Regular.otf");
